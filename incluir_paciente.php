<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        // IMC
        $Imc = $paciente->calculaImcPaciente();
        $paciente->setImc($Imc);
        ...
        if($paciente->getInclusaoEfetuada()) {
            ...
            <META HTTP-EQUIV=REFRESH CONTENT = '0;URL=
            http://localhost/SysClinica/index.php?pagina=incluir_paciente.php'
            ";
        }
    }
    ...
    <form action="index.php?pagina=incluir_paciente.php" method="post">
        <div class="form-inline">
            <div class="col-lg-13">
                ...
                <label style="margin-left: 150px;" class="form-group">UF</label>
                ...
                <input maxlength="40" style="width: 345px;" type="text" name="email" class="form-control" placeholder="Máximo 60 caracteres..." required><br/>
